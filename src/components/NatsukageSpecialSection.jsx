  ...
  return (
    <div className="retro-box retro-box-gold animate-fade-in" style={{ padding: '24px', background: 'linear-gradient(180deg, #0c2647 0%, #031024 100%)' }}>
      <div className="retro-title-bar retro-title-bar-orange" style={{ fontSize: '1.25rem' }}>
        ...
        <span>【特別特集】 旋律『夏影 -Natsukage-』と「あの夏」を取り戻す巡礼の美学</span>
      </div>
      ...
      {/* 夏影の世界観詩的バナー */}
      <div style={{ background: 'rgba(234, 88, 12, 0.25)', border: '2px solid #f97316', padding: '18px', borderRadius: '4px', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '14px' }}>
        <Feather color="#fbbf24" size={36} className="glow-text" />
        <div>
          <div className="font-mincho" style={{ color: '#fbbf24', fontSize: '1.3rem', fontWeight: 'bold' }}>
            『夏影』の情景を感じたとき、そこがあなたの「あの夏」になる。
          </div>
          <div style={{ fontSize: '0.9rem', color: '#fed7aa', marginTop: '4px' }}>
            麻枝准が生み出した不朽の名曲。煙樹ヶ浜の波音と蝉の声、茜色の夕空に身を委ねて想いを巡らせてください。
          </div>
        </div>
      </div>
...
もしあなたが和歌山・美浜町へと足を運ぶのなら、できれば【7月下旬から8月中旬】——太陽が容赦なく地面を焼き、アスファルトの向こうに陽炎が揺らめく真夏の盛りに旅立ってほしい。

なぜなら、『夏影』という楽曲の持つあの澄み渡る雰囲気は、
...
観鈴が目覚める前の静かな時間。世界に自分一人しかいないような、透明度の高い寂寥感が心の一番深い場所に届く。
